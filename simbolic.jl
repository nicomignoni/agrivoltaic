...
# ╔═╡ d446df40-093b-4151-9078-5df87ed15bc1
using BlockDiagonals

# ╔═╡ de5c3611-edd6-437c-addb-73e566146a99
using Symbolics

# ╔═╡ 1ab8baf5-69c3-4bc2-a988-e1ae08b85ebb
using Latexify

# ╔═╡ 92870cf3-66b8-485d-a6e8-a5c52c8559ce
include("utils.jl")

# ╔═╡ d7caacf8-360d-43f7-b865-605a2f149490
panel = Dict(
	"pos_east" => (@variables c_i),
	"pos_north" => (@variables cᵢ₂),
	"height" => (@variables cᵢ₃),
	"width" => (@variables w_i),
	"depth" => (@variables d_i)
)

# ╔═╡ 36dfc770-06fb-481a-88ce-c9db6908bae9
base_vertices(panel["width"], panel["depth"])

# ╔═╡ 511ced8c-e7d8-45db-84b9-7f0dcbe494f8


# ╔═╡ 70bb0b8b-f5b4-4695-a73d-72299b3f30a5


# ╔═╡ 1ecd3cba-1bb0-4122-9ebc-da831b6e8592


# ╔═╡ 8ff37c8b-ea69-457a-a712-96de37d0491e


# ╔═╡ ba3fcf18-b1e6-46a6-920e-8a7c207e287d


# ╔═╡ 1448333b-68b7-441c-bb93-2dd7a86bd560


# ╔═╡ 3b71300b-bb42-4f24-a4de-95d4178ee208


# ╔═╡ 4d688b35-d7ca-4cac-9d99-b9c818356416


# ╔═╡ f3ceb783-fb37-4602-9243-f60fd9e38f32


# ╔═╡ 2a190129-585e-4e54-af88-6b2bc6e92e13


# ╔═╡ 6b09a0f1-af17-4c92-95a6-e56c215ac2fd
...
manifest_format = "2.0"
project_hash = "e18996ada151f1cd59dda318d969486d070c0f23"
